...
tests = TestList [
    ...
    TestCase (assertEqual "Day 12 part 1"         1415378 . day12p1 =<< readFile "../inputs/input12.txt"),
    TestCase (assertEqual "Day 12 part 2"          862714 . day12p2 =<< readFile "../inputs/input12.txt"),
